...
export class HUE extends ethereum.SmartContract {
  static bind(address: Address): HUE {
    return new HUE("HUE", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get _proportions(): Array<BigInt> {
    return this._call.inputValues[3].value.toBigIntArray();
  }

  get _vestingBeneficiary(): Address {
  ...
  get _tokenVestingInstance(): Address {
